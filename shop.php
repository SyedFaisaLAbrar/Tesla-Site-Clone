...
<body>
    ...
    <div class="main-content">
        ...
        <div class="products">
            ...
            <div class="box">
                <div class="upper-section-slider">
                <div class="slider">
                            <img id="mySlides" src="img/accessories/20 Sport Wheels.png">
                            <img id="mySlides" src="img/accessories/19 Sport Wheels.png">
                            <img id="mySlides" src="img/accessories/18 Aero Wheels.png">
                            <img id="mySlides" src="img/accessories/20 Zero-G Wheels (Performance).png">
                            <img id="mySlides" src="img/accessories/19 Gemini Wheels (Performance).png">
                        </div>
                </div>
                <div class="lower-section">
                <a href="#">
